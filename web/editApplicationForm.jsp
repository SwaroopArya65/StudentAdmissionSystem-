<%-- 
    Document   : editApplicationForm
    Created on : 31 Aug, 2021, 5:46:35 PM
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <form action="EditApplicationFormServlet?studentId=<%=register.getStudentId()%>" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="dob" value="<%=student.getDob()%>" class="form-control"  placeholder="Select DOB" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fatherName" value="<%=student.getFatherName()%>" class="form-control" placeholder="Enter Father's Name" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="motherName" value="<%=student.getMotherName()%>" class="form-control" placeholder="Enter Mother's Name" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="city" value="<%=student.getCity()%>" class="form-control" placeholder="Enter City/Town/Village" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <label>Post</label>
                                <input type="text" name="post" value="<%=student.getPost()%>" class="form-control" placeholder="Enter Post" required>
                                <div class="invalid-feedback">
                                    Please Enter Post
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="policeStation" value="<%=student.getPoliceStation()%>" class="form-control" placeholder="Enter Police Station" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pinCode" value="<%=student.getPinCode()%>" class="form-control" placeholder="Enter Pin Code" required>
                                <div class="invalid-feedback">
                                    Please Enter Pin Code
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary w-50" disabled>Update Application</button>
                            </div>
                        </form>
                        <br>
                        <br>
