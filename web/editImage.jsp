<%-- 
    Document   : editImage
    Created on : 8 Sep, 2021, 5:37:50 PM
    ...
    <body>
        ...
        <div id="outerDiv">
            ...
            <div class="container mt-3">
                ...
                <form action="UpdateImageServlet?studentId=<%=register.getStudentId()%>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <div class="text-center">
                                <img height="100px" width="100px" id="showPhoto" src="UploadImage/UploadPhoto/<%=student.getPhotoName() %>">
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="text-center">
                                <img height="50px" id="showSignature" width="150px" src="UploadImage/UploadSignature/<%=student.getSignatureName() %>">
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-primary w-50" disabled>Update Image</button>
                    </div>
                </form>
                <br>
                <br>
